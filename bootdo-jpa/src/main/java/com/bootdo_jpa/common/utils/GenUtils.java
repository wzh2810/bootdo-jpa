...
import com.bootdo_jpa.common.domain.ColumnDO;
import com.bootdo_jpa.common.domain.ColumnsDO;
import com.bootdo_jpa.common.domain.TableDO;
...
public class GenUtils {
    ...
    public static List<String> getTemplates() {
        ...
        templates.add("templates/common/generator/Repository.java.vm");
     ...
     * 生成代码
     */
    public static void generatorCode(TablesDO table,
                                     List<ColumnsDO> columns, ZipOutputStream zip) {
        //配置信息
