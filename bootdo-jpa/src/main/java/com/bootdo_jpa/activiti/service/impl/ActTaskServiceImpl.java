...
import com.bootdo_jpa.activiti.service.ActTaskService;
...
//        vars.put("title","");
    ...
    public String startProcess(String procDefKey, String businessTable, Long businessId, String title, Map<String, Object> vars) {
        ...
        // 启动流程
        //ProcessInstance procIns = runtimeService.startProcessInstanceByKey(procDefKey, businessId.toString(), vars);
